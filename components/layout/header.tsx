          ...
          <nav className="hidden md:flex items-center space-x-4">
            {user ? (
              <>
                ...
                {isAdmin && (
                  <Link href="/admin">
                    <Button variant="ghost" className="text-black hover:bg-[#FFF2EB] flex items-center gap-1">
                ...
                <>
                  ...
                  {isAdmin && (
                    <Link href="/admin" onClick={() => setIsMenuOpen(false)}>
                      <Button
                        variant="ghost"
                        className="w-full justify-start text-black hover:bg-[#FFF2EB] flex items-center gap-2"
                      >
                        <Shield className="h-4 w-4" />
                        Admin
                      </Button>
